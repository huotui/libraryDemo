...
import { getBooksApi, createBookApi, updateBookApi, deleteBookApi, getCategoriesApi, borrowBookApi } from '../api/library'
...
const form = reactive({ title: '', author: '', isbn: '', category_id: '', publisher: '', publish_date: '', total_copies: 999 })
...
const showEditDialog = (row) => {
  isEdit.value = true
  editId.value = row.id
  Object.assign(form, { title: row.title, author: row.author, isbn: row.isbn, category_id: row.category_id, publisher: row.publisher, publish_date: row.publish_date, total_copies: row.total_copies })
  dialogVisible.value = true
}

const resetForm = () => {
  Object.assign(form, { title: '', author: '', isbn: '', category_id: '', publisher: '', publish_date: '', total_copies: 999 })
  editId.value = null
}
